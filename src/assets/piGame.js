...
function initializePiGame() {
  ...
  degreesToRad = (ang) => ang * (Math.PI / 180);
  ...
  sfx = [, , 925, 0.04, 0.3, 0.6, 1, 0.3, , 6.27, -184, 0.09, 0.17];
  audio = new Audio(
    "https://assets.codepen.io/539557/2019-12-11_-_Retro_Platforming_-_David_Fesliyan.mp3"
  );
  audio.volume = 0.1;
  audio.loop = true;
